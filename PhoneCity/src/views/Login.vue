<template>
  <div class="login">
    ...
    <img class="logo" src="../assets/xiaomilogo.png" alt="">
    <div v-if="type == 'login'" class="login-body login">
      <van-form @submit="onSubmit" class="login-user">
        <van-field
          v-model="username"
          name="username"
          label="用户名"
        ...
        />
        <div class="verify">
          <Verify ref="loginVerifyRef" @error="error" :showButton="false" @success="success" :type="1"></Verify>
        </div>
    ...
    <div v-else class="login-body register">
      <van-form @submit="onSubmit">
        ...
        <div style="margin: 16px;">
          <div class="link-login" @click="toggle('login')">已有账号,<a href="#">去登陆</a></div>
